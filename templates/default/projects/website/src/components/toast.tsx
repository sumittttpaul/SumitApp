...
export default function Toast({ title, onExit }: { title?: string; onExit?: () => void }) {
  return (
    <div className="relative flex max-w-[calc(100%)] items-center justify-self-center-safe overflow-hidden rounded-xl bg-black p-1 text-white max-sm:gap-x-1 max-sm:p-2 sm:max-w-md dark:bg-white dark:text-black">
