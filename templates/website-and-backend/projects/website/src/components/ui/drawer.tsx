  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        <div className="bg-popover relative flex size-full flex-col rounded-2xl">
          <span className="mx-auto mt-2.5 hidden h-1 w-16 shrink-0 rounded-full bg-black/20 group-data-[vaul-drawer-direction=bottom]/drawer-content:block dark:bg-white/20" />
          {children}
        </div>
      </DrawerPrimitive.Content>
    </DrawerPortal>
